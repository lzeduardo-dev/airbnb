...
const Register = ({ setUser }) => {
  ...
  return (
    <section className="flex items-center">
      <div className="mx-auto max-w-96 w-full flex flex-col gap-4 p-8 items-center my-20">
        <h1 className="font-bold text-3xl">Faça seu registro</h1>
        <form
          action=""
        ...
        <p className="">
          Ja possui uma conta?
          <Link to="/login">
            <span className="underline">Logue aqui!</span>
          </Link>
        </p>
      </div>
    </section>
