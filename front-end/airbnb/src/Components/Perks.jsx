...
export const Perks = () => {
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-2">
      <label
        htmlFor="wifi"
        className=" flex gap-2 items-center border border-gray-300 px-2 py-4 rounded-lg"
      >
        <input
          type="checkbox"
          id="wifi"
      ...
      <label
        ...
        className="flex gap-2 items-center border border-gray-300 px-4 py-6 rounded-lg"
      >
        <input
          type="checkbox"
          id="free-parking"
